...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> WOOD_CHAIR = BLOCKS.register("wood_chair",
            () -> new ChairBlock(AbstractBlock.Properties.of(Material.WOOD)
                    .strength(1.5f)
                    .noOcclusion()));
    ...
    public static final RegistryObject<Block> WOOD_TABLE = BLOCKS.register("wood_table",
            () -> new TableBlock(AbstractBlock.Properties.of(Material.WOOD)
                    .strength(2.0f)
                    .noOcclusion()));
    ...
    public static final RegistryObject<Block> RED_SOFA = BLOCKS.register("red_sofa",
            () -> new SofaBlock(AbstractBlock.Properties.of(Material.WOOL)
                    .strength(1.0f)
                    .noOcclusion()));
